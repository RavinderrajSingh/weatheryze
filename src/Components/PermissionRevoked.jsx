...
function PermissionRevoked({ checkPermissions, getLocation, isPermissionGranted }) {
    ...
    return (
        <div className='flex flex-col items-center justify-center w-full h-full p-4'>
            <div className='text-2xl md:text-3xl font-bold mb-4'>PLEASE GRANT LOCATION PERMISSION</div>
            <div className='text-base md:text-lg mb-4'>We need access to your location to get weather data for your current location.</div>
            <button
